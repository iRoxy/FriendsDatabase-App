 ...
 */
public class FriendsCustomAdapter extends ArrayAdapter<Friends> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        editButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(FriendsContract.FriendsColumns.FRIENDS_ID, String.valueOf(_id)); // send paramaters to next activity
